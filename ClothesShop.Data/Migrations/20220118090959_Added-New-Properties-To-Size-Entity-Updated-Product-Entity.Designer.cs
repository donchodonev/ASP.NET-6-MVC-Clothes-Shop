...
namespace ClothesShop.Data.Migrations
{
    ...
    [Migration("20220118090959_Added-New-Properties-To-Size-Entity-Updated-Product-Entity")]
    partial class AddedNewPropertiesToSizeEntityUpdatedProductEntity
    {
            ...
            modelBuilder.Entity("ClothesShop.Data.Entities.Order", b =>
                {
                    ...
                    b.HasOne("ClothesShop.Data.Entities.ShippingAddress", "ShippingAddress")
                        .WithMany("Orders")
